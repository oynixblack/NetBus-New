<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        {
            $query = mysqli_query($conn, "UPDATE login SET code='{$code}'  WHERE username='{$email}'");
            if($query){
                ...
                try {
                    ...
                    $mail->Body    = 'To reset your password click <a href="http://localhost/NETBUSSP/change_passlogin.php?reset='.$code.'">Click Here</a></b>';
