	...
	<body>
		...
		<div class="wrapper" style="background-image: url('images/5.jpg');">
			<div class="inner">
				...
				<form action="ownerregacc.php" method="POST" enctype="multipart/form-data">
...
<span id="msg4" style="color:red;">Ownership</span>
...
var pas1=document.getElementById("password");
	...
	return true;
					...
					<button type="submit" name="submit"><i class="zmdi zmdi-arrow-right"></i>Register</button>
