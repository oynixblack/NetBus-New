...
if (isset($_GET['status'], $_GET['id'])) {
    ...
    $conn = connect()->query("UPDATE login SET status = '$status' WHERE loginid = '$id'");
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table style="width: 100%;" id="example1" style="align-items: stretch;"
                                    ...
                                    <tbody>
                                        <?php
                                        $row = mysqli_query($conn,"SELECT * FROM  owner inner join login on login.loginid=owner.loggid ORDER BY owner.oid DESC");
                                        ...
                                        while ($fetch =mysqli_fetch_array($row)) {
                                            ...
                                            <td><?php echo "<img src='uploads/".$fetch['image']."' width='120px' height='80px'";?></td>
                                            ...
                                            <td>
                                                <?php
                                                    if ($fetch['status'] =="0") {
                                                    ?>
                                                <a href="admin.php?page=owners&status=1&id=<?php echo $fetch['loginid']; ?>">
                                                    <button
                                                ...
                                                <a href="admin.php?page=owners&status=0&id=<?php echo $fetch['loginid']; ?>">
                                                    <button
