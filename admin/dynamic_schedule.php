                            ...
                            <table id="example1" style="align-items: stretch;"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Bus</th>
                                        <th>Route</th>
                                        <th>Window Seat Fee</th>
                                        <th>Second Seat Fee</th>
                                ...
                                <tbody>
                                    ...
                                    while ($fetch = $row->fetch_assoc()) {
                                        $id = $fetch['id']; ?><tr>
                                        <td><?php echo ++$sn; ?></td>
                                        <td><?php echo getTrainName($fetch['bus_id']); ?></td>
                                        ...
                                        <td><?php $array = getTotalBookByType($id);
                                                echo (($array['first'] - $array['first_booked'])), " Seat(s) Available for Window Seats" . "<hr/>" . ($array['second'] - $array['second_booked']) . " Seat(s) Available for Second Seats";
                                                ?></td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="" method="post">
                                                        ...
                                                        <p>
                                                           Window Seat Charge : <input class=""
                                                                type="number" value="<?php echo $fetch['first_fee'] ?>"
                                                                name="first_fee" required id="">
                                                        </p>
                                                        <p>
                                                            Second Seat Charge : <input class="form-control"
        ...
        <div class="modal-content" align="center">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                           Window Seat Charge : <input class="form-control" type="number" name="first_fee" required
                                id="">
                        </div>
                        <div class="col-sm-6">

                            Second Seat Charge : <input class="form-control" type="number" name="second_fee" required
                                id="">
                        </div>
                    </div>
                    <div class="row">
