    ...
    <div class="main-top">
        <div class="container-fluid">
            <div class="row">
				...
				<a class="navbar-brand" href="index.html"><img src="image/1.png" class="logo" alt=""></a>
					<div class="login-box">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                 ...
                 <li class="nav-item active"><a class="nav-link" href="index.php">Home</a></li>
                        <li class="nav-item"><a class="nav-link" href="register.php">E-ticketing</a></li>
                        <li class="nav-item"><a class="nav-link" href="about.php">About Us</a></li>
                        <li class="nav-item"><a class="nav-link" href="busownerregister.php">Bus Owner Registration</a></li>
        ...
        <ul class="slides-container">
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br>NetBus E-ticketing</strong></h1>
                            <div class="btn-bar">

<a href="login.php" class="btn btn-custom theme_background_color">Make Bookings Now</a>
            ...
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Book Local Bus Tickets Online Now</strong></h1>
                            <div class="btn-bar">

<a href="pro/signin.php" class="btn btn-custom theme_background_color">Make Bookings Now</a>
            ...
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Book your Reservation And Travel Hussle-Free!! </strong></h1>
                            <div class="btn-bar">
...
<a href="pro/signin.php" class="btn btn-custom theme_background_color">Make Bookings Now</a>
				...
				<div class="row">
					<div class="col-lg-4 col-md-12 col-sm-12">
						<div class="footer-top-box">
							<h3>SMOOTHER LOCAL BUS BOOKING</h3>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-sm-12">
                        <div class="footer-widget">
                            <h4>About NetBus E-ticketing</h4>
    ...
    <div class="footer-copyright">
        <p class="footer-company">NetBus E-ticketing
    </div>
    <!-- End copyright  -->
